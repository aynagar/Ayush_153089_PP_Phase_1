...
public class Client
{
	...
	public void menu()
	{
		...
		case 5:
			...
			System.out.println("Amount " + amount1 + " Transferred to the Account with customer name : " + customer.getName());
			System.out.println("Updated balance is " + customer.getWallet().getBalance());
			break;
		case 6:
			 customer = null;
			...
			customer = serviceObject.showTransaction(customerMobileNo1);
			transactionDetails1 = customer.getTransactions().getTransactionDetails();
