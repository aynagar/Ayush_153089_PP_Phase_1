...
public class WalletServiceImpl implements WalletService 
{
	...
	public Customer depositAmount(String mobileNo, BigDecimal amount) 
	{
		...
		if(customer1 != null)
		{
			...
			updatedBalance1 = updatedBalance1.add(amount);
			...
			customer1.getTransactions().getTransactionDetails().add("Wallet with mobile number: "+customer1.getMobileNo()+" credited with "+ amount+" on "+dateFormat.format(dateOfTransaction)+" with Updated balance: "+customer1.getWallet().getBalance());
	...
	public Customer withdrawAmount(String mobileNo, BigDecimal amount) 
	{
		...
		if(customer1 != null)
		{
			...
			if(comp>0)
			{
			updatedBalance1 = updatedBalance1.subtract(amount);
			wallet = new Wallet(updatedBalance1);
			
			customer1.setWallet(wallet);
			
			Date dateOfTransaction = new Date();
			customer1.getTransactions().getTransactionDetails().add("Wallet with mobile number: "+customer1.getMobileNo()+" debited with "+ amount+" on "+dateFormat.format(dateOfTransaction)+" with Updated balance: "+updatedBalance1);
	...
	public Customer fundTransfer(String sourceMobileNo, String targetMobileNo, BigDecimal amount) 
	{
		...
		if(customer1 != null && customer2 != null)
		{
			...
			updatedBalance2 = updatedBalance2.add(amount);
			...
			customer1.getTransactions().getTransactionDetails().add("Wallet with mobile number: "+customer1.getMobileNo()+" has Fund transfer of "+ amount+" to mobile number "+customer2.getMobileNo()+" on "+dateFormat.format(dateOfTransaction)+" with Updated balance: "+customer1.getWallet().getBalance());
			
            
			dateOfTransaction = new Date();
			customer2.getTransactions().getTransactionDetails().add("Wallet with mobile number: "+customer2.getMobileNo()+" has Fund transfer of "+ amount+" from mobile number "+customer1.getMobileNo()+" on "+dateFormat.format(dateOfTransaction)+" with Updated balance: "+customer2.getWallet().getBalance());
